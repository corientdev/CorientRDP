...
class EntryWindow(Gtk.Window):
    def __init__(self):
        ...
        # init window
        super().__init__(title="Corient RDP")
        ...
        self.multi_monitor = Gtk.CheckButton(label="Multi Monitor")
        # self.multi_monitor.connect("toggled", self.on_editable_toggled)
        self.multi_monitor.set_active(self.config["multimonitor"])
        self.nb_page2.pack_start(self.multi_monitor, False, False, 0)
    ...
    def build_parameters(self):
        ...
        if self.check_fullscreen.get_active():
            args.append("/f")
        if self.multi_monitor.get_active():
    ...
    def load_config(self):
        ...
        self.config = {
            ...
            "multimonitor": config["multimonitor"] if "multimonitor" in config else True,
    ...
    def save_config(self):
        ...
        config = {
            ...
            "multimonitor": self.multi_monitor.get_active(),
